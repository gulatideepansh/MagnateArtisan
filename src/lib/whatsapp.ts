...
export function whatsappUrl(product?: Product, customNote?: string, referenceNote?: string) {
  ...
  const lines = [
    ...
    "",
    customNote || "Please help me with sizing, customization, embroidery options, fabric choices, and delivery timing.",
  ].filter(Boolean);
