...
## Corpus Check
- 72 files · ~59,628,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 326 nodes · 609 edges · 23 communities (18 shown, 5 thin omitted)
...
4. `SiteHeader()` - 10 edges
5. `formatMoney()` - 10 edges
6. `ProductPage()` - 9 edges
...
- `ScrollButton()` --calls--> `cn()`  [EXTRACTED]
  src/components/capability-rail.tsx → src/lib/utils.ts
...
Cohesion: 0.12
Nodes (20): steps, metadata, metadata, Home(), CollectionCard(), FaqList(), Reveal(), ScrollProgress() (+12 more)
...
Cohesion: 0.08
Nodes (22): CollectionDetailPage(), CollectionStackHero(), MeasurementGuides(), Stack(), StackProps, defaultProduct(), TryOnClient(), getCollection() (+14 more)

### Community 8 - "page.tsx"
Cohesion: 0.24
Nodes (15): includedPieces(), occasionTags(), ProductPage(), ProductCard(), ProductGallery(), ProductEditor(), getProduct(), relatedProducts() (+7 more)
...
Cohesion: 0.21
Nodes (9): GET(), metadata, TestimonialsPage(), ReviewWall(), TestimonialCard(), fallbackTestimonials, Testimonial, EtsyReview (+1 more)
